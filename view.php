...
<style>
    ...
    .challenge-card:hover .card-img-top {
    ...
    .challenge-card:hover .btn-arrow {
        background: #27ae60;
        color: white;
    }
    ...
    <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4">
        <?php if ($result && $result->num_rows > 0): ?>
            <?php while ($row = $result->fetch_assoc()): 
                ...
                $imgUrl = "https://loremflickr.com/600/400/" . urlencode($searchTerm) . "?lock=" . $row['challengeID'];
            ?>
                <div class="col">
                    <div class="challenge-card">
                        ...
                        <div class="card-img-wrapper">
                            ...
                            <img src="<?= $imgUrl ?>" class="card-img-top" alt="<?= htmlspecialchars($searchTerm) ?>">
                        </div>
